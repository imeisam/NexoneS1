...
Config.CommandName = "menu" -- command to open the menu
...
Config.Discord = "https://discord.gg/nexone" -- discord link to show when you ban a player in the ban message
...
Config.EnableReports = false -- enable reports
--[[
