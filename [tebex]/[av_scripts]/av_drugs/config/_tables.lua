...
Config.MaxTablesPerPlayer = 2 -- Max tables the same player can place at the same time, keep it low otherwise too many entities spawned close will take too much CPU
...
Config.PlayerCooldown = false -- Player won't be able to cook in any table for X time or false if u don't want players cooldown