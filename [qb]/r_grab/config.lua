...
Config = {
    ...
    AttachPosition2 = vector3(0.20, 0.45, 0.0), 
    AttachPosition = vector3(0.28, 0.25, 0.0), -- Positioning of the player facing the police officer
    -- AttachPosition = vector3(0.22, 0.38, 0.0),
    Animations = {
        policeAnimation = {
