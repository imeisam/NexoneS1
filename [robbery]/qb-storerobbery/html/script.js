...
function updateCashDisplay() {
  ...
  function cellClick() {
    ...
    if (this.classList.contains('golden')) {
        ...
        if (specialItemGlobal === '' || specialItemGlobal === null) {
            currentCashValue = Math.floor(currentCashValue * 1.5);
        }
        ...
        const fixedIncreaseAmount = Math.floor(initialCashValue * (cashMultiplier ));
  ...
  function gameOver() {
    ...
    fetch('https://qb-storerobbery/gameOver', {
      method: 'POST',
      headers: {
