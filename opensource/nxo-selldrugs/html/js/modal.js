...
function handleUserChoice(choice) {
    $('#modal').fadeOut();
    $.post('https://nxo-selldrugs/modalChoice', JSON.stringify(choice));
}
...
function showDeleteConfirmationModal() {
    ...
    $('#modal-button-accept').off('click').on('click', function() {
        if (currentDisplayedConversationId !== undefined) {
            $.post('https://nxo-selldrugs/playerDeletedConversation', JSON.stringify(currentDisplayedConversationId));
