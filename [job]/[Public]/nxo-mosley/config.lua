...
Config.SignInTarget = false

-- Set to false to disable Mosley Autos blip
Config.EnableMosleyAutoBlip = false
...
Config.PayCheckMaxAmount = 500

-- Start of Give Bonus Items --
Config.BonusItems = {
    {item = 'lockpick', chance = 5}, -- 30% chance
    {item = 'meth_bag', chance = 10}, -- 30% chance
}
-- Random Amount of given Bonus items
Config.RNGMinAmount = 0
Config.RNGMaxAmount = 1
-- End of Bonus Items --

-- 40000 = 40 seconds
Config.UpgradingTime = 40000

-- Set how long does it takes for spawned vehicle to auto delete after vehicle is picked up
Config.DelVehTime = 30 -- 30 Minutes

-- Change how long it will take for a job to arrive.
Config.MinReceiveJobTime = 60 -- in seconds
Config.MaxReceiveJobTime = 240 -- in seconds
...
Config.PedList = {
	{
		model = "ig_benny",
		coords =vector3(1105.6529541016, -3190.8337402344, -68.965301513672),
		heading = 140.3,
		gender = "male",
