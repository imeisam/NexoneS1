...
RegisterNUICallback('CreateScene', function(data, cb)
  toggleNuiFrame(false)
  editingScene = false
  TriggerServerEvent('qb-scenes:server:createScene', sceneData)
  cb({})
end)
...
RegisterNetEvent('qb-scenes:client:startScenes', function()
  ToggleSceneLaser()
end)

RegisterNetEvent('qb-scenes:client:updateAllScenes', function(data)
  scenes = data
end)

RegisterNetEvent('qb-scenes:client:addScene', function(data)
  scenes[#scenes+1] = data
end)

RegisterNetEvent('qb-scenes:client:removeScene', function(sceneId)
  for i = 1, #scenes do 
              ...
              if IsControlJustReleased(0, 38) then
                  ...
                  if hit then
                    ...
                    toggleNuiFrame(true)
                      ...
                      QBCore.Functions.Notify("Laser did not hit anything.", "error")
                  end
