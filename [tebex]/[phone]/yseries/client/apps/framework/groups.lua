...
exports("GetJobStage", function() return CurrentJobStage end)
exportHandler('yseries', "GetJobStage", function() return CurrentJobStage end)

-- Returns Clients current groupId
exports("GetGroupId", function() return GroupId end)
exportHandler('yseries', "GetGroupId", function() return GroupId end)

-- Returns if the Client is the group leader.
exports("IsGroupLeader", function() return IsGroupLeader end)
exportHandler('yseries', "IsGroupLeader", function() return IsGroupLeader end)
