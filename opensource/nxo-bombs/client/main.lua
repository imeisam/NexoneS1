...
RegisterNetEvent('bbv-bombs:plantbomb:sync',function(data)
    ...
    Wrapper:Target(Bombs[data.position].position,label,Bombs[data.position].position,event,type,data.position.x..data.position.y..data.position.z)
end)
...
RegisterNetEvent('bbv-bombs:defuse:client',function(data)
    ...
    exports['qb-interact']:RemoveInteraction('bomb-'..data.x..data.y..data.z)
...
AddEventHandler('bbv-bombs:explode:client', function (data)
    ...
    exports['qb-interact']:RemoveInteraction('bomb-'..data.position.x..data.position.y..data.position.z)
...
RegisterNetEvent('bbv-bombs:beep',function(pos, maxDistance)
    ...
    if distance < maxDistance then
        ...
        local adjustedVolume = 0.2 * (1 - distanceRatio)
        SendNUIMessage({
