...
Config.Locations[#Config.Locations+1] = { --[[ GABZ ALTA STREET BENNYS ]]--
	...
	stash = {
		{ coords = vector4(-195.939453125, -1319.5169677734, 32.211402893066, 115.25254058838), w = 3.6, d = 0.8, },
	},
	store = {
		{ coords = vec3(-199.5970916748, -1319.1927490234, 32.098575592041), w = 3.60, d = 0.8 },
	},
	crafting = {
...
-- 	autoClock = { enter = true, exit = true, },
-- 	stash = {
-- 		{ coords = vec4(102.7, 6626.23, 31.79, 315.0), w = 1.6, d = 1.0, },
-- 	},
-- 	store = {
