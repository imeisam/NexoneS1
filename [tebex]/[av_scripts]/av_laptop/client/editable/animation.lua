...
function openLaptop() -- Triggered when player opens laptop // just in case u want to trigger something (?)

end

function closeLaptop() -- Triggered when player closes laptop // just in case u want to trigger something (?)
