...
cfg.Police 			   = {
	Job = {"police"},
	Required = 4							-- How many police officers should be on duty to start drug sales?
}
...
cfg.Drug_List = {
	-- 	["zatpackedweed"] 	= {average_price = 180},
	-- 	["coke_pure"] 		= {average_price = 110},
		["meth_bag"] 		= {average_price = 200},
	-- 	["crack"] 			= {average_price = 200},
	 	["heroin"] 			= {average_price = 350},
	-- 	["zatjoint"] 		= {average_price = 200},
...
cfg.Wholesale_Settings = {
	...
	minQuantity = 50,
	maxQuantity = 300,
	Respect = 25, 						-- Add when trade is done/Remove when you leave zone
