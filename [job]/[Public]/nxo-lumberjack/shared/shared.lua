...
function destroyProp(entity)
	...
	DeleteObject(entity)
	TriggerEvent("fivem-appearance:client:ClearStuckProps", QBCore.Functions.GetPlayerData().source)
end
...
function toggleItem(give, item, amount) TriggerServerEvent("jim-lumberjack:server:toggleItem", give, item, amount) end
