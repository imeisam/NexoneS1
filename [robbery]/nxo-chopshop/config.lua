...
Config.CoolDown = 30       -- How long people must wait before starting another job (in minutes)

Config.Email = false -- The sent number plate comes to your phone as an e-mail. If you are going to use Orbit UI, make it false.
...
Config.VehicleCoords = {        -- Locations of where the vehicle can spawn **Chosen from random every time you start a new job**,
    ...
    [2] = {coords = vector4(-1609.647, -382.792, 42.70383, 52.535), radarCoords = vector3(-1636.34, -374.05, 43.78) },
    [3] = {coords = vector4(97.57888, -1946.472, 20.27978, 215.933),radarCoords = vector3(102.8, -1982.58, 20.79)   },
    [4] = {coords = vector4(437.5428, -1925.465, 24.004, 28.82286), radarCoords = vector3(436.09, -1875.0, 27.23)   },
    [5] = {coords = vector4(438.4482, -1838.672, 27.47369, 42.8129),radarCoords = vector3(436.36, -1820.41, 27.98)  },
    [6] = {coords = vector4(-950.63, -2088.74, 8.79, 43.85),radarCoords = vector3(-962.16, -2070.6, 9.41)  },
    [7] = {coords = vector4(1263.17, -715.71, 63.99, 238.89),radarCoords = vector3(1253.37, -703.77, 64.5)  },
    [8] = {coords = vector4(1003.78, -516.08, 60.18, 204.53),radarCoords = vector3(1004.45, -499.31, 60.71)  },
    [9] = {coords = vector4(873.58, -598.89, 57.69, 319.35),radarCoords = vector3(882.92, -614.1, 58.22)  },
    [10] = {coords = vector4(1015.39, -423.31, 64.51, 215.9),radarCoords = vector3(1000.48, -415.64, 65.36)  },
    [11] = {coords = vector4(1056.81, -387.14, 67.34, 221.41),radarCoords = vector3(1050.13, -369.6, 68.24)  },
    [12] = {coords = vector4(1103.05, -398.86, 67.13, 76.81),radarCoords = vector3(1123.63, -390.14, 68.5)  },
    [13] = {coords = vector4(1109.79, -781.15, 57.75, 178.2),radarCoords = vector3(1082.73, -787.45, 58.34)  },
    [14] = {coords = vector4(260.81, -1715.26, 28.79, 51.3),radarCoords = vector3(260.81, -1715.26, 28.79)  },
}
