...
Config.maxAssignTime = { -- Max time someone can be assigned - set false if undesired(In minutes)
    crutch = false, -- Crutch / default: 10 minutes(set false if not desired a limit)
    wheelchair = false -- Wheelchair / default: 10 minutes(set false if not desired a limit)
 }
...
Config.usableCrutchItem = { -- Usable item settings
    ...
    maxAssignTime = false, -- Max time someone can be assigned crutches - set false if undesired(In minutes)
...
Config.usableWheelchairItem = { -- Usable item settings
    ...
    maxAssignTime = false, -- Max time someone can be assigned wheelchair - set false if undesired(In minutes)
