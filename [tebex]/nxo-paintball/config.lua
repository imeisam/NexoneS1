...
Config.SurrenderCommand = 'surrender' -- this is a command to surrender the paintball match (wouldnt change this)
...
Config.RedTeamRadio = 999 -- Radio channel the red team gets put on too.
Config.BlueTeamRadio = 998 -- Radio channel the blue team gets put on too.
...
------------------------------
Config.PedLocation = vector4(-1283.4, -304.55, 35.15, 26.98) -- The location of the ped where join the game.
...
Config.Arenas = {
    ...
    --     map = 'titanic',
    --     url = '',
    --     description = 'Ready for Titanic?',
    --     ZoneCenter = vector3(-358.1, -4084.14, 9.32), -- if you add a zone center vector to the map listing it will create a zone around a map location so players cant leave it.
    --     Radius = 100, -- put a radius value here for how big the zone should be.
    --     -- This is how you make new maps wherever you want throughout the gta 5 world.
    -- },
    -- [19] = {
    --     name = 'In Door Arena',
...
Config.RedTeamSpawns = {
    ...
    ['titanic'] = { -- titanic
    [1] = vector4(-312.98, -4036.29, 9.36, 80.36),
    [2] = vector4(-311.69, -4037.56, 9.34, 164.3),
    [3] = vector4(-310.63, -4038.97, 9.32, 197.09),
    [4] = vector4(-309.13, -4040.97, 9.32, 190.51),
    [5] = vector4(-307.19, -4043.41, 9.32, 206.39),
    [6] = vector4(-305.19, -4045.69, 9.32, 202.98),
    [7] = vector4(-303.75, -4047.55, 9.34, 196.21),
    [8] = vector4(-302.66, -4049.67, 9.36, 189.4),
    [9] = vector4(-304.64, -4050.84, 9.35, 131.93),
    [10] = vector4(-306.8, -4048.21, 9.32, 60.74),
    [11] = vector4(-309.32, -4045.13, 9.32, 45.44),
    [12] = vector4(-311.48, -4042.33, 9.32, 60.76),
    [13] = vector4(-318.49, -4052.1, 11.13, 143.73),
    [14] = vector4(-327.22, -4068.0, 9.32, 100.95),
    [15] = vector4(-337.9, -4065.39, 14.98, 113.65),
    },
}
------------------------------------------------
------------------------------------------------
...
Config.BlueTeamSpawns = {
    ...
    ['titanic'] = { -- titanic
    [1] = vector4(-417.17, -4147.2, 9.32, 308.23),
    [2] = vector4(-418.53, -4145.46, 9.32, 28.11),
    [3] = vector4(-420.17, -4143.55, 9.32, 23.45),
    [4] = vector4(-421.95, -4141.41, 9.32, 29.59),
    [5] = vector4(-423.53, -4139.68, 9.32, 27.59),
    [6] = vector4(-425.04, -4137.96, 9.32, 24.89),
    [7] = vector4(-425.89, -4134.57, 9.32, 318.83),
    [8] = vector4(-427.8, -4132.74, 9.32, 25.08),
    [9] = vector4(-427.47, -4130.22, 9.32, 331.12),
    [10] = vector4(-422.76, -4130.66, 9.32, 269.13),
    [11] = vector4(-420.13, -4136.4, 9.32, 261.27),
    [12] = vector4(-415.66, -4141.72, 9.32, 297.99),
    [13] = vector4(-398.32, -4134.6, 13.34, 281.33),
    [14] = vector4(-413.23, -4115.24, 13.34, 311.67),
    [15] = vector4(-418.81, -4129.45, 17.34, 307.55),
    },
}
------------------------------------------------
------------------------------------------------
...
Config.FFASpawns = {
    ...
    ['titanic'] = { -- titanic
    [1] = vector4(-406.92, -4116.14, 21.34, 43.25),
    [2] = vector4(-414.93, -4127.61, 17.34, 237.19),
    [3] = vector4(-397.34, -4125.85, 25.34, 129.09),
    [4] = vector4(-412.41, -4135.81, 17.34, 190.07),
    [5] = vector4(-390.95, -4127.14, 17.34, 59.58),
    [6] = vector4(-392.87, -4116.74, 17.34, 37.77),
    [7] = vector4(-415.71, -4145.56, 9.32, 263.7),
    [8] = vector4(-427.08, -4133.9, 9.32, 354.85),
    [9] = vector4(-417.65, -4120.83, 9.32, 308.48),
    [10] = vector4(-398.78, -4107.79, 9.32, 233.5),
    [11] = vector4(-387.04, -4120.39, 9.32, 224.19),
    [12] = vector4(-371.8, -4106.0, 9.32, 12.39),
    [13] = vector4(-385.16, -4097.0, 11.99, 48.64),
    [14] = vector4(-372.39, -4112.18, 11.99, 259.55),
    [15] = vector4(-379.48, -4113.29, 17.83, 307.34),
    [16] = vector4(-362.77, -4077.77, 9.32, 37.38),
    [17] = vector4(-356.48, -4085.23, 9.32, 223.12),
    [18] = vector4(-349.95, -4092.32, 9.32, 8.89),
    [19] = vector4(-339.82, -4079.87, 9.32, 35.46),
    [20] = vector4(-344.89, -4073.43, 9.32, 38.74),
    [21] = vector4(-336.56, -4056.99, 9.32, 226.77),
    [22] = vector4(-328.09, -4066.71, 9.32, 223.03),
    [23] = vector4(-321.82, -4063.92, 9.32, 134.07),
    [24] = vector4(-329.15, -4055.06, 9.32, 38.21),
    [25] = vector4(-322.53, -4051.3, 11.13, 193.22),
    [26] = vector4(-309.31, -4051.37, 11.13, 184.93),
    [27] = vector4(-305.45, -4048.78, 9.33, 240.58),
    [28] = vector4(-312.76, -4039.12, 9.33, 191.53),
    [29] = vector4(-350.27, -4077.07, 12.19, 314.86),
    [30] = vector4(-340.56, -4067.33, 14.98, 205.99),
    },
