...
--     TriggerEvent('qb-doorlock:server:updateState', 'jail-door5', true, src, false, true, false, false,src)
--     for i=1, 27, 1 do
--         local door = 'cell_door_' .. i
--         TriggerEvent('qb-doorlock:server:updateState', door, true, src, false, true, false, false,src)
--     end
...
--         TriggerEvent('qb-doorlock:server:updateState', 'jail-door5', false, src, false, true, false, false,src)
--         for i=1, 27, 1 do
--             local door = 'cell_door_' .. i
--             TriggerEvent('qb-doorlock:server:updateState', door, false, src, false, true, false, false,src)
--         end
...
RegisterNetEvent('qb-jail:server:ClearLockDown', function()
    ...
    if Player.PlayerData.job.name == 'police' then -- Player.PlayerData.job.name == 'police'
