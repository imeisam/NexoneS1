...
$(document).on("click", "#create-group", function(e) {
    ...
    setTimeout(function() {
        ...
        $.post("https://nxo-grouptablet/CreateJobGroup", JSON.stringify({}), function() {});
    }, loadScreen);
});

function showNotification() {
    playSound("notify.ogg", "./sounds/", 0.6);
    $.post("https://nxo-grouptablet/readyToJob", JSON.stringify({}), function() {});
}
...
$(document).on("click", "#check-out", function(e) {
    e.preventDefault();
    $.post("https://nxo-grouptablet/checkOut", JSON.stringify({}), function() {});
});
...
$(document).on("click", "#join-group", function (e) {
    e.preventDefault();
    var id = $(this).data('id');
    $.post("https://nxo-grouptablet/RequestToJoin", JSON.stringify({id: id}), function() {});
});

$(document).on("click", "#disband-group", function(e) {
    var id = $(this).data('id');
    $.post("https://nxo-grouptablet/DisbandGroup", JSON.stringify({id: id}), function() {});
});

$(document).on("click", "#leave-group", function(e) {
    var id = $(this).data('id');
    $.post("https://nxo-grouptablet/LeaveGroup", JSON.stringify({id: id}), function() {});
});
