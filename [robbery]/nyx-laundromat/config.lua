...
Config.Usb = {
    usbchance = 0, -- chance for the usb to spawn in the laundromat
...
Config.Safe = {
    ...
    reward = { -- reward for cracking the safe
        ...
        amount = {min = 30000, max = 40000}, -- amount of the item to give (randomized)
    },
}

Config.WasherRewards = {
    item = 'coin', -- items that is set in the washer inventory
    amount = {min = 300, max = 400}, -- amount of the item you get from the washer (randomized)
}
