        ...
        local player = GetPlayerByCid(sender)
            if player then
                ...
                if CoreName == "qb-core" or CoreName == "qbx_core" then
                    AddMoney(player.PlayerData.source, "bank", math.floor(senderMoney + 0.5), "bill-commision From "..playerbil.PlayerData.charinfo.firstname.." "..playerbil.PlayerData.charinfo.lastname)
