...
RegisterNetEvent("qb-customs:client:openBenny", function()
    EnterLocation({coords = GetEntityCoords(PlayerPedId()), heading = GetEntityHeading(PlayerPedId())})
end)

RegisterNetEvent("qb-customs:client:openPolice", function()
    EnterLocation({coords = GetEntityCoords(PlayerPedId()), heading = GetEntityHeading(PlayerPedId()), categories = {
        repair = true,
        mods = false,
        armor = false,
        respray = true,
