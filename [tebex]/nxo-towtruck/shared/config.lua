...
Config.JobOptions = {
    ...
    milPrice = 5,    -- Additional fee per mile
    levelPrice = 20, -- Additional fee per level
    classMultiplier = {
        [0] = 1.0,    -- Compacts
        [1] = 1.0,    -- Sedans
        [2] = 1.2,    -- SUVs
    ...
    finishCoords = vector3(-232.86308288574, -1400.9500732422, 31.293947219849),
    maxExp = 500,
    ranks = { 0, 50, 100, 200, 300, 400, 500 },
...
Config.PedOptions = {
    {
        ...
        spawnCoords = {
            vector4(-190.38172912598, -1380.4833984375, 30.259492874146, 216.32482910156),
            vector4(-195.32522583008, -1383.2918701172, 30.247549057007, 221.48181152344),
        }
    },
}
