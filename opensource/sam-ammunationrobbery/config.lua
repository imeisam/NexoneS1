...
config.reward={
    {name='pistol_part_1',count=math.random(1,3)},
    {name='pistol_part_2',count=math.random(1,3)},
    {name='pistol_part_3',count=math.random(1,3)},
    {name='pistol_part_4',count=math.random(1,3)},
}
