...
RegisterNetEvent('Ranjit-EmsBag:Client:MenuAmbulanceBag', function(bagid)
    local playerPed = PlayerPedId()
    ...
    exports['qb-menu']:openMenu({
        ...
        { header = "[👜] Open AmbulanceBag", args = {bagid=bagid},  params = { event = "Ranjit-EmsBag:Client:StorageAmbulanceBag" } },
