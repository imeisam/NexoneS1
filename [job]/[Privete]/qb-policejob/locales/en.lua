local Translations = {
    ...
    info = {
        ...
        stash = 'Stash %{value}',
        delete_spike = '[E] Delete Spike Strip',
        close_camera = 'Close Camera',
        bullet_casing = 'Bullet Casing %{value}',
        casing = 'Bullet Casing',
        blood = 'Blood',
        blood_text = 'Blood %{value}',
        fingerprint_text = 'Fingerprint',
        fingerprint = 'Fingerprint',
        store_heli = 'Store Helicopter',
        take_heli = 'Take Helicopter',
        store_boat = 'Store Boat',
        take_boat = 'Take Boat',
