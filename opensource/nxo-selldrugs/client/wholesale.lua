...
function Wholesale_Trade(buyer)
    ...
    local AnimPos = GetOffsetFromEntityInWorldCoords(buyer, Random_Anim.Offset.x, Random_Anim.Offset.y, Random_Anim.Offset.z)
    local Height = AnimPos.z - GetEntityHeightAboveGround(buyer)
    FreezeEntityPosition(ped, true)
    SetEntityCoords(ped, AnimPos.x, AnimPos.y, Height)
    SetEntityHeading(ped, GetEntityHeading(buyer) - 180)
