...
Config= {}
Config.stretcher="trump-stretcher"
Config.Hash = {
	...
	-- {hash = "medic13", detection = 4.8, depth = -3.0, height = 0.45},
	{hash = "ambulance", detection = 4.2, depth = -2.2,width=0.2, height =-0.245,outputz=-0.18},
	{hash = "rambulance", detection = 4.1, depth = -3.0,width=0, height = 0.13,outputz=0.02},
}
