...
Config.MaterialCheck = 1 -- How many trash bags each person MUST turning in to recieve a ticket 8 = 1 ticket, scales with group so if its a 3 man group they need to turn in 24 and they will all recieve 1 ticket
