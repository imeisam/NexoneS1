...
Config.craftables = {
    ...
    [2] = { 
        name ='advancedrepairkit', --- !! for ox weapons it must be upper case (weapon_pistol50 will not work) (WEAPON_PISTOL50 will work)
    ...
    -- [11] = { 
    --     name = "washmachine", -- !! for ox weapons it must be upper case (weapon_pistol50 will not work) (WEAPON_PISTOL50 will work)
    --     model = "m23_2_prop_m32_blueprt_01a",
    --     info = {
    --     }, -- item metadata
    --     zoffset = 0.0,
