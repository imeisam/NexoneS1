...
Citizen.CreateThread(function()
	...
	if Config.Target == "ox_target" and Config.InventoryType == "ox_inventory" then
...
CreateThread(function()
	Wait(1000)
	if Config.SkilledRodGame == "qb-skillbar" then
		if GetResourceState("qb-skillbar") ~= 'started' then
			print"^2 YOU NEED TO INSTALL THE ^3'qb-skillbar' ^2RESOURCE. ^1PLEASE READ THE README.TXT"
		end
	end
	if Config.ProfessionalRodGame == "qb-lock" then
		if GetResourceState("qb-lock") ~= 'started' then
			print"^2 YOU NEED TO INSTALL THE ^3'qb-lock' ^2RESOURCE. ^1PLEASE READ THE README.TXT"
		end
	end
end)