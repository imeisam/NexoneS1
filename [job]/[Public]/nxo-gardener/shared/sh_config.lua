...
Config.FuelType = false --'legacy_fuel' -- legacy_fuel / ox_fuel / ps_fuel
...
AddToPlayer = {
    ...
    Missions = {
        ...
        weed1 = vec4(-2018.2094, 479.0862, 106.1619, 69.8974),
        weed2 = vec4(-2018.0143, 480.1909, 106.1526, 75.5682),
        weed3 = vec4(-2020.2554, 477.6495, 106.1619, 341.5254)
     },
     ["Mission2"] = {
