local Translations = {
    ...
    info = {
        ...
        wep_unknown = 'Unknown',
        respawn_txt = 'RESPAWN IN ~r~%{time}~s~ SECONDS',
        respawn_revive = 'HOLD [~r~E~s~] FOR ~r~%{holdtime}~s~ SECONDS TO RESPAWN FOR ~r~$%{cost}~s~',
        unconscious_txt = 'UUCONSCIOUS IN ~r~%{time}~s~ SECONDS',
        unconscious_revive = 'HOLD [~r~E~s~] FOR ~r~%{holdtime}~s~ SECONDS TO UUCONSCIOUS',
