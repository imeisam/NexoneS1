...
RegisterServerEvent('qb-yatch:server:GetPlayerName')
  AddEventHandler('qb-yatch:server:GetPlayerName', function()
      local player = QBCore.Functions.GetPlayer(source)
      local playerName = player.PlayerData.charinfo.firstname .. ' ' .. player.PlayerData.charinfo.lastname
      TriggerClientEvent('qb-yatch:client:LogObjectSpawn', source, playerName)
  end)
