...
RegisterNetEvent("0r-towtruck:client:notification", function(msg)
...
Koci.giveVehicleKey = function(vehicle)
    -- add trigger
   local plate= Framework.Functions.GetPlate(vehicle)
...
RegisterNetEvent("0r-towtruck:client:updateData", function(data)
    myLevel = data.level
    myExp = data.exp
    myPhoto = data.photo
