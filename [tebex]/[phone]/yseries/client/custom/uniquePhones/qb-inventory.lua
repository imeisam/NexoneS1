CreateThread(function()
    if Config.Item.Inventory ~= "qb-inventory" and Config.Item.Inventory ~= "lj-inventory" and Config.Item.Inventory ~= "ps-inventory" or not Config.Framework == 'qb' then return end
