...
window.addEventListener('message', function(event) {
    ...
    if (ed.action === "openDealership") {
		...
		testbutton=ed.testbutton;
		buybutton=ed.buybutton;
		...
		ed.vehicles.forEach(function(vehicleData, index) {
			...
			<div id="showroomDivBottomRightDiv">
				<div id="showroomDivBottomRightDivTop">
					...
					<img src="https://assets.nopixel.net/dev/images/showroom/${vehicleData.model}.webp" loading="lazy">
				</div>
		...
		ed.vehicles.forEach(function(vehicleData, index) {
			if (vehicleData.stock >= 1 || !ed.stoke) {
				...
				if (ed.stoke ){
					stockText=`${vehicleData.stock}x Stock`;
...
function clFunc(name1, name2, name3, name4, name5, name6) {
	if (name1 === "showCategoryVehicles") {
		...
		vehicles.forEach(function(vehData, index) {
			if (vehData.category === name2) {
				...
				<div class="MDBCDVehicleDiv" id="MDBCDVehicleDiv-${vehData.spawncode}" onclick="clFunc('chooseVeh', '${vehData.spawncode}', '${vehData.categoryLabel}', '${vehData.price}', '${vLabel}', '${vehData.stock}')">
					...
					<img src="https://assets.nopixel.net/dev/images/showroom/${vehData.model}.webp" style="width: auto;height: 80px;position: absolute;scale: 3.2;" loading="lazy" onerror="this.onerror=null; this.src='https://cam.nxone.ir/other/noimage.png';">
					<div></div>
		...
		if (testbutton){
			document.getElementById("MDSPaymentDivBottomTestButton").style.display = "flex";
		}else{
			document.getElementById("MDSPaymentDivBottomTestButton").style.display = "none";
		}
	...
	document.getElementById("mainDivBottomCenterDiv").innerHTML = vehicles.map((vehicle) => {
		...
		return (
			`<div class="MDBCDVehicleDiv ${divClass}" id="MDBCDVehicleDiv-${spawncode}" onclick="clFunc('chooseVeh', '${spawncode}', '${categoryLabel}', '${price}', '${vLabel}', '${stock}')">
				...
				<img src="https://assets.nopixel.net/dev/images/showroom/${model}.webp" style="width: 150px; height: 90px;" loading="lazy">
				<div id="MDBCDVehicleDivBottom">
		...
		return (
			`<div id="showroomDivBottomRightDiv">
				<div id="showroomDivBottomRightDivTop">
					...
					<img src="https://assets.nopixel.net/dev/images/showroom/${model}.webp" loading="lazy">
				</div>
