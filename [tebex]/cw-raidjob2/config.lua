...
local highLoc = {
    ...
    lakevinewood2 = {
        ...
        Guards = {
            { model = 'g_m_m_chicold_01', weapon = 'weapon_pistol' },
...
local lowJob = {
    ...
    Rewards = {
        { item = 'lockpick', amount = math.random(1, 5), chance = 10 },
        { item = 'cash', amount = 1, chance = 20 }
    }
}
...
local highJob = {
    ...
    Messages = {
        ...
        Aquired = {
            sender = 'MRPD Dispatch',
            subject = 'documents',
            message = "Looks like you got the case. It's got a tracker on it. It'll stop soon."
        },
        Finish = {
            sender = 'MRPD Dispatch',
            subject = 'documents',
            message = "Good shit. Now unlock it with the key and bring the documents here."
        },
    },
    Boss = {
        coords = vector4(461.5, -1008.68, 22.08, 336.88),
        model = 's_m_y_cop_01',
        missionTitle = "Secret Docs",
        animation = 'WORLD_HUMAN_HANG_OUT_STREET', -- OPTIONAL https://pastebin.com/6mrYTdQv
    },
    Rewards = {
        { item = 'lockpick', amount = math.random(1, 5), chance = 10 },
