...
Config.RecordTime = 60          --Recording Time | 30 = 30 seconds | [*note: Dont increase the time too much or it may not upload to any service you are using for example - discord.]
...
Config.WatchLoc = {
    [1] = {
        coords = vector3(-1080.7288818359, -824.19299316406, 27.147211074829), 
        rad = 0.3, 
        debug= false,
        jobCam = {'police'},  -- jobs mentioned here are shown in the list | false = able to view all the bodycams
    ...
    [2] = {
        coords = vector3(460.95, -985.08, 30.69), 
        rad =0.3, 
        debug= false,
        jobCam = {'police'},  -- jobs mentioned here are shown in the list | false = able to view all the bodycams
        carCam = {                        -- false = able to view all the dashcams
    ...
    [3] = {
        coords =vector3(349.81, -1430.55, 32.5), 
        rad = 0.5, 
        debug= false,
        jobCam = {'ambulance'},  -- jobs mentioned here are shown in the list | false = able to view all the bodycams
        carCam = {                        -- false = able to view all the dashcams
            job = {'ambulance'},             -- Jobs that activate dashcams shown in the list | false excludes.
            class = {18}                  -- Dashcam activated on these vehicleclass shown in the list | false excludes.
        },
        targetAuth = {'ambulance'},          -- jobs mentioned here can use this location from target | false = everyone can access this location
