...
(function() {
  ...
  Howl.prototype = {
    ...
    _refreshBuffer: function(sound) {
      ...
      sound._fxInsertOut.disconnect();
      if (sound._panner) {
        sound._fxInsertOut.connect(sound._panner);
        //panner sends audio to _node and _fxSend, so do NOT send source data
      } else {
        sound._fxInsertOut.connect(sound._node); // send data into output (dry)
        sound._fxInsertOut.connect(sound._fxSend); // send data into convolver over _fxSend (wet)
      }
