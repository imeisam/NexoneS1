...
Config.CompatibleManagmentScripts = { -- Having a compatible managment script is not required
    "Renewed-Banking",
    "okokBanking",
    "qb-banking", -- QBCore has updated there framework. qb-managment use to be where the account money managment was but now it is handled by qb-banking. If you are still using the old frameworks ways then you can delete qb-banking from here.
    "qb-management",
    "prime-management",
    "esx_society"
}
