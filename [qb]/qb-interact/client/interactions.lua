...
function api.getNearbyInteractions()
    ...
    if amountOfInteractions > 0 then
        for i = 1, amountOfInteractions do
            ...
            if interaction and interaction.global then
                addGlobalVehicleData(interaction, options, playercoords)
                amount = #options
                goto skip
            end

            if interaction and  interaction.globalPlayer then
                addGlobalPlayerData(interaction, options, playercoords)
                amount = #options
                goto skip
            end

            if interaction and  interaction.model then
            ...
            if interaction and  interaction.netId then
