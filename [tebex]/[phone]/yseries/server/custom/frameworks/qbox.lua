CreateThread(function()
    ...
    Framework = {
        ...
        GetPlayerFromIdentifier = function(citizenid)
            local qbPlayer = exports.qbx_core:GetPlayerByCitizenId(citizenid)
            if not qbPlayer then
                return nil
            end
    ...
    function RefreshCompanies()
        ...
        for i = 1, #Config.Companies.Services do
            ...
            for _, jobName in ipairs(Config.Companies.AppearAsAlwaysAvailable) do
            ...
            if isPoliceJob and Config.Companies.PoliceAlwaysAvailable then
    ...
    lib.callback.register('yseries:server:companies:get-employees-ids', function(_, job)
        ...
        if players[1] then
            for _, value in pairs(players) do
                local employee = exports.qbx_core:GetPlayerByCitizenId(value.citizenid)
