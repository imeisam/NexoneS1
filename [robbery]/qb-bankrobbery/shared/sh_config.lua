...
Config.Banks = {
    ['PinkCage'] = {
        ...
        thermite = {
            [1] = {
                coords = vector4(313.37, -285.48, 54.14, 154.85),
                ptfx = vector3(313.48, -285.69, 54.14),
                doorId = 'fleeca-fleeca-pinkage', -- Door at: -1307.68, -813.94, 17.15
                hit = false
            }
        }
    },
    ['Legion'] = {
        ...
        thermite = {
            [1] = {
                coords = vector4(149.00640869141, -1047.0904541016, 29.56594581604, 152.70495605469),
                ptfx = vector3(149.00640869141, -1047.0904541016, 29.86594581604),
                doorId = 'fleeca-legion', -- Door at: -1307.68, -813.94, 17.15
                hit = false
            }
        }
    },
    ['Hawick'] = {
        ...
        thermite = {
            [1] = {
                coords = vector4(-351.7, -56.44, 49.01, 150.48),
                ptfx = vector3(-351.7, -56.41, 49.01),
                doorId = 'fleeca-hawick', -- Door at: -1307.68, -813.94, 17.15
                hit = false
            }
        }
    },
    ['DelPerro'] = {
        ...
        thermite = {
            [1] = {
                coords = vector4(-1208.45, -335.8, 37.76, 202.47),
                ptfx = vector3(-1208.45, -335.78, 37.76),
                doorId = 'fleeca-lifeinvader', -- Door at: -1307.68, -813.94, 17.15
                hit = false
            }
        }
    },
    ['GreatOcean'] = {
        ...
        thermite = {
            [1] = {
                coords = vector4(-2956.09, 484.08, 15.68, 269.05),
                ptfx = vector3(-2956.12, 484.06, 15.68),
                doorId = 'fleeca-chumash', -- Door at: -1307.68, -813.94, 17.15
                hit = false
            }
        }
    },
    ['Sandy'] = {
        ...
        thermite = {
            [1] = {
                coords = vector4(1173.51, 2713.19, 38.07, 355.59),
                ptfx = vector3(1173.51, 2713.19, 38.07),
                doorId = 'fleeca-route68', -- Door at: -1307.68, -813.94, 17.15
                hit = false
            }
        }
    },
    --[[['Maze'] = {
        ...
        thermite = {
            [1] = {
                ...
                doorId = 'mazethermite', -- Door at: -1307.68, -813.94, 17.15
                hit = false
            }
        }
    },]]
    ['Paleto'] = {
        ...
        thermite = {
            [1] = {
                ...
                doorId = 5, -- Door at: vector3(-106.08, 6475.3, 31.63) | 'paletothermite' for nui_doorlock
                hit = false
            }
        }
    },
    ['Pacific'] = {
        ...
        hacked = false,
        card = false,
        cardDoor = 1, -- Door at: 261.89, 221.88, 106.28 - 'pacificgoldcard' for nui_doorlock
        policeClose = false,
        object = 961976194,
        heading = {
            closed = 160.00,
        ...
        thermite = {
            [1] = {
                ...
                doorId = 6, -- Door at Location: 256.96, 220.38, 106.29 - 'pacificthermite1' for nui_doorlock
                hit = false
            },
            [2] = {
                coords = vector4(253.01703, 220.73141, 101.78381, 162.6746),
                ptfx = vector3(253.11703, 221.53141, 101.78381),
                doorId = 2, -- Door at location: 252.6, 221.14, 101.68 - 'pacificthermite2' for nui_doorlock
                hit = false
            },
            [3] = {
                coords = vector4(261.66752, 215.73648, 101.78382, 261.99899),
                ptfx = vector3(261.69946, 216.82735, 101.78382),
                doorId = 3, -- Door at location: 261.17, 215.28, 101.68 - 'pacificthermite3' for nui_doorlock
                hit = false
            }
        }
    },
    ['Vault'] = {
        ...
        goldhacked = false,
        lockdown = false,
        laptopDoor = 'pacificextended', -- Door at location: 255.42, 228.99, 101.68
        powerplantHit = false,
        lasersActive = false,
        hacked = false,
        code = false,
