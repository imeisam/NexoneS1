RegisterNetEvent('orbit-chopshop:wheelanimation')
AddEventHandler('orbit-chopshop:wheelanimation', function()
...
RegisterNetEvent('orbit-chopshop:dooranimation')
AddEventHandler('orbit-chopshop:dooranimation', function()
	local ped = PlayerPedId()
...
RegisterNetEvent('orbit-chopshop:trunkanimation')
AddEventHandler('orbit-chopshop:trunkanimation', function()
	local ped = PlayerPedId()
...
RegisterNetEvent('orbit-chopshop:hoodanimation')
AddEventHandler('orbit-chopshop:hoodanimation', function()
	local ped = PlayerPedId()
...
RegisterNetEvent('orbit-chopshop:wheelchopanim')
AddEventHandler('orbit-chopshop:wheelchopanim', function()
	local ped = PlayerPedId()
	...
	exports["orbit_emotes"]:EmoteCommandStart("weld")
	Citizen.Wait(12000)
	ClearPedTasks(ped)
...
RegisterNetEvent('orbit-chopshop:doorchopanim')
AddEventHandler('orbit-chopshop:doorchopanim', function()
	local ped = PlayerPedId()    
...
RegisterNetEvent('orbit-chopshop:hoodchopanim')
AddEventHandler('orbit-chopshop:hoodchopanim', function()
	local ped = PlayerPedId()    
...
RegisterNetEvent('orbit-chopshop:trunkchopanim')
AddEventHandler('orbit-chopshop:trunkchopanim', function()
	local ped = PlayerPedId()
