...
function Wrapper:Target(id,label,pos,event,type,idtarget) -- QBTarget target create
    if Config.Settings.Target == "QB" then 
        -- local sizex = 1
        -- local sizey = 1
        exports['qb-interact']:AddInteraction({
            coords =vector3(pos.x,pos.y,pos.z-1),
            distance = 4.0, -- optional
            interactDst = 1.2, -- optional
            id = "bomb-"..idtarget, -- needed for removing interactions
            name = "bomb-"..idtarget, -- optional
            options = {
                {
                    type = "client",
