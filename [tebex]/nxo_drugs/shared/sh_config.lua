...
Config.Clothing = "qb-clothing" -- fivem-appearance, esx_skin, qb-clothing, custom | change in client/cl_Utils.lua | GetSkin = function() | ApplySkin = function()
--PLAYER CONTROL
Config.Logs = { enabled = false, type = "webhook" } -- use webhook or ox_lib (datadog) Can be changed in server > sv_utils.lua
...
Config.Madrazo = {
    ...
    Description = "Trade 50x Gold Coin for Lab access!",
    Available = { -- Time
        enabled = false, from = 1, to = 22
    },
    RequiredItems = {
        { item = "token", count = 30, remove = true },
    },
    AddItems = {
    ...
    Log = "Has Traded 30x Gold Coin for 1 Meth Access Card"
}
...
Config.Gerald = {
    ...
    Description = "Trade 50 Gold Coin for 1 Coke Lab with Gerald!",
    Available = { -- Time
    ...
    Log = "Has Traded 30x Gold Coin for 1 Coke Access Card"
}
...
--     Package = {
--         header = "Pack Weed",
--         description = "Ingredients: 5x Weed bud",
...
--         },
--         Log = "Has proccessed 5x Weed bud into 1x Weed Packed"
--     },
-- }
...
Config.Meth = {
    ...
    Package = {
        header = "Pack Meth",
        description = "Ingredients: 1x Broken Meth tray",
        ...
        Log = "Has proccessed 1x Broken Meth tray into 1x Meth bag"
...
Config.Heroin = {
    --Field
    Field = {
        coords = vector3(1869.7, 4909.16, 45.73),
        radius = 15,
        Duration = 8000,
        name = "PoppyField",
        debugPoly = false,
    ...
    Process = {
        ...
        description = "Ingredients: 3x Poppy plant, 1x Amoniak", 
        coords = vector3(1443.27, 6331.18, 23.98),
        radius = 0.4,
        Teleport = vector3(1443.27, 6331.18, 23.98),
        Duration = 15000,
        RequiredItems = {
            { item = "poppyplant", count = 6, remove = true },
            { item = "meth_amoniak", count = 2, remove = true },
        },
        AddItems = {
            { item = "heroin", count = 1 },
        },
        Log = "Has proccessed 3x Poppy plant, 1x Amoniak into 1x heroin"
    },
}
...
Config.Crack = {
    ...
    Process = {
        ...
        RequiredItems = {
            ...
            { item = "powder", count = 1, remove = true },
...
Config.Coke = {
    ...
    Field = {
        ...
        name = "Cokefield",
        RequiredItems = {
            { item = "trowel", count = 2, remove = false },
        },
        AddItems = {
...
Config.Drugs = {
    weed_package = { -- Item name
        ...
        MinPrice = 275, -- Min price
        MaxPrice = 650, -- Max price
    ...
    meth_bag = { -- Item name
        ...
        ReqPolice = 1, -- Police count
        ReportChance = 25, --Dispatch Chance 0 - 100 %
        MinPrice = 2225, -- Min price
        MaxPrice = 4575, -- Max price
        MinCount = 1, -- Min Count
        MaxCount = 5, -- Max Count
    ...
    crack = { -- Item name
        ...
        ReqPolice = 1, -- Police count
        ReportChance = 25, --Dispatch Chance 0 - 100 %
        MinPrice = 715, -- Min price
        MaxPrice = 1248, -- Max price
        MinCount = 1, -- Min Count
        MaxCount = 5, -- Max Count
        Chance = 65, -- 0 - 100% succes of negotiate for better price
        AttackChance = 5, -- 0 - 100% Chance of NPC atacking player
        animation = {
            model = `bkr_prop_weed_bag_01a`,
            pos = vec3(0.16, 0.04, -0.05),
    ...
    heroin = { -- Item name
        ...
        ReqPolice = 1, -- Police count
        ReportChance = 25, --Dispatch Chance 0 - 100 %
        MinPrice = 775, -- Min price
        MaxPrice = 1175, -- Max price
        MinCount = 1, -- Min Count
        MaxCount = 5, -- Max Count
        Chance = 65, -- 0 - 100% succes of negotiate for better price
        AttackChance = 5, -- 0 - 100% Chance of NPC atacking player
    ...
    coke_figure = { -- Item name
        ...
        ReqPolice = 1, -- Police count
        ReportChance = 25, --Dispatch Chance 0 - 100 %
        MinPrice = 2000, -- Min price
        MaxPrice = 6225, -- Max price
        MinCount = 1, -- Min Count
        MaxCount = 5, -- Max Count
        Chance = 65, -- 0 - 100% succes of negotiate for better price
        AttackChance = 5, -- 0 - 100% Chance of NPC atacking player
