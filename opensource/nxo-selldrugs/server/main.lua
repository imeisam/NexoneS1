...
cfg.Prefix.Functions.CreateCallback('SellDrugs:Calculate_Percentage', function(source, cb, itemName, price, isWholesale)
    ...
    if not itemConfig then
        ...
        Send_Discord_Log(3447003, translate("server", "discord_hacker_title", GetPlayerName(src), src, xPlayer.PlayerData.citizenid), "inside-scripts (Advanced Drug Sales 💊)", translate("server", "discord_hacker_calculate_percentage_message", full_name, itemName, price, mode), "Support - discord.gg/URKNMSwx5W")
        return
    end
