...
Config = {
    ...
    BallSetupCost = '', -- for example: "$1" or "$200" - any text
    ...
    Text = {
        ...
        AIM_LEFT = "Aim Point left",
        AIM_RIGHT = "Aim Point Right",
        AIM_SLOWER = "Aim Point Slow",

        POOL = 'Billar',
        POOL_GAME = 'Billiards game',
        POOL_SUBMENU = 'Configuration',
        TYPE_8_BALL = '8-ball',
        TYPE_STRAIGHT = 'Straight pool',

        HINT_SETUP = 'Place table',
        HINT_TAKE_CUE = 'Take stick',
        HINT_RETURN_CUE = 'Leave stick',
        HINT_HINT_TAKE_CUE = 'To play you must take a stick',
        HINT_PLAY = 'Play',
        ...
        BALL_POCKETED = '%s has been put in',
        BALL_IN_HAND_NOTIFY = 'The player has the white ball in his hand',
        BALL_LABELS = {
            [-1] = 'White',
            [1] = '~y~Lisa 1~s~',
            [2] = '~b~Lisa 2~s~',
