...
RegisterNUICallback('successInteraction', function(data, cb)
    ...
    local AnimPos = GetOffsetFromEntityInWorldCoords(UsingPed, Random_Anim.Offset.x, Random_Anim.Offset.y, Random_Anim.Offset.z)
    local Height = AnimPos.z - GetEntityHeightAboveGround(UsingPed)
    FreezeEntityPosition(ped, true)
    SetEntityCoords(ped, AnimPos.x, AnimPos.y, Height)
    SetEntityHeading(ped, GetEntityHeading(UsingPed) - 180)
