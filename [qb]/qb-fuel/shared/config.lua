...
Config.CostMultiplier = 1.5 -- Amount to multiply 1 by. This indicates fuel price. (Default: $3.0/l or 3.0)
...
Config.FuelTargetExport = false -- This is only used to fix this issue: https://github.com/CodineDev/qb-fuel/issues/3. <br> <br> If you don't have this issue and haven't installed this exports in qb-target, then this should be false. Otherwise there will be an error.
-- Anims --
Config.ElectricChargingPrice=1.0
Config.RenewedPhonePayment=false
Config.PumpHose=true
Config.RefuelAnimDict = 'weapon@w_sp_jerrycan' -- Used for Jerry Can
Config.RefuelAnimationDictionary = "timetable@gardener@filling_can"
Config.RefuelAnimation = "gar_ig_5_filling_can"
Config.RefuelAnim = 'fire' -- Used for Jerry Can
Config.petrolcanbye=5
Config.vehiclebatterybuy=35
--- Jerry Can ----- 
...
Config.chargermodel={
    "bzzz_pumps_charger_b",
    "bzzz_pumps_charger_a",
    "bzzz_pumps_homecharger_a",
    "bzzz_pumps_homecharger_b",
}
...
Config.chargestationBlips = { -- Blip Locations
------electronic charger
vector3(709.80456542969, 238.50332641602, 92.863273620605),
vector3(1018.9343261719, -757.27075195312, 57.991706848145),
vector3(69.517875671387, -1560.1586914062, 29.460214614868),
vector3(-789.59057617188, -2396.4089355469, 14.570714950562),
vector3(136.38906860352, 6577.2744140625, 32.056339263916),
vector3(-966.43328857422, -1475.5897216797, 5.0194873809814),
}
