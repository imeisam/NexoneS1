...
Config.FrameworkTarget = 'qb-target' --qtarget or qb-target or ox_target / auto-detect
...
Config.FuelType = 'qb-fuel' -- legacy_fuel / ox_fuel / ps_fuel
Config.Menu = 'ox_lib' -- qbcore / ox_lib
Config.Progress = 'qbcore' -- qbcore / ox_lib
...
Config.GetDownFromLadder = 177 -- backspace here you can find all keybinds - https://docs.fivem.net/docs/game-references/controls/
...
Config.StartJobLocation = {223.5230, 121.5480, 101.8371} -- Target location with npc position
Config.NpcHeading = {266.0367}

Config.Blip = {
    Pos = {224.5012, 121.4229, 102.6104},
    Sprite = 354,
    Display = 4,
    Scale = 1.0, 
    Colour = 3,
...
Config.Blips = {
    ...
    private = {
        ...
        Colour = 5,
        Scale = 1.0,
        Name = 'Electrical fusebox'
    }
}

Config.SpawnCoords = {231.6542, 126.7930, 102.5997, 203.2729} -- vehicle spawn location
