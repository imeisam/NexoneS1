...
Config.VehiclesConfig = {
    ["npolmm"] = {
        ["A"] = {
            ...
            ["fDriveInertia"] =0.700000,
            ["fBrakeForce"] = 0.580000,
        },
        ["A+"] = {
            ["fInitialDriveForce"] =0.450000,
            ["fDriveInertia"] = 0.69999998807907,
            ["fBrakeForce"] = 0.680000,
        },
        ["S"] = {
            ["fInitialDriveForce"] =0.7300000,
            ["fDriveInertia"] = 0.89999998807907,
            ["fBrakeForce"] = 0.780000,
        },
        ["S+"] = {
            ["fInitialDriveForce"] =0.99000001192093,
            ["fDriveInertia"] =0.99999998807907,
            ["fBrakeForce"] = 2.3799999952316,
        }
    },
    ["police3"] = {
        ["A"] = {
    ...
    ["gbpolstanierle"] = {
        ["A"] = {
            ["fMass"] = 1400.0,
            ["fDriveInertia"] =1.3300000,
            ["fInitialDriveForce"] =0.37500,
            ["fInitialDriveMaxFlatVel"]=145.000000,
            ["fBrakeForce"]=0.7250000,
            ["fHandBrakeForce"]=0.800000,
        },
        ["A+"] = {
            ["fMass"] = 1400.0,
            ["fDriveInertia"] =0.8000,
            ["fInitialDriveForce"] =0.57500,
            ["fInitialDriveMaxFlatVel"]=145.000000,
            ["fBrakeForce"]=0.80000,
            ["fHandBrakeForce"]=0.800000,
        },
        ["S"] = {
            ["fMass"] = 2000.0,
            ["fDriveInertia"] =1.6300000,
            ["fInitialDriveForce"] = 0.7000,
            ["fInitialDriveMaxFlatVel"]=150.000000,
            ["fBrakeForce"]=0.80000,
            ["fHandBrakeForce"]=0.9,
        },
