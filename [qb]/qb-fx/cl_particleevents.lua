...
local peePooWhitelist = {
  ["STEAM_0:1:17549569"] = true, -- Sanyo
}
local mySteamId = nil
Citizen.CreateThread(function()
  Wait(10000)
  TriggerServerEvent("qb-fx:setSteamId")
end)
RegisterNetEvent("qb-fix:setSteamIdClient")
AddEventHandler("qb-fix:setSteamIdClient", function(id)
  mySteamId = id
end)
...
--exports["qb-keybinds"]:registerKeyMapping(""","Misc", "Make it Rain", "+makeItRain", "-makeItRain")
