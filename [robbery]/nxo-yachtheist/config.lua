...
Config.MinCop = 0 -- amount of cops needed for the heist
...
-- hack 1
Config.Hack1Item = 'usb_blue'-- item needed for hack 1 
Config.Hack1Time = 10 -- amount of time player has to do the hack
...
-- hack 2
Config.Hack2Item = 'black_usb'-- item needed for hack 1 
Config.Hack2Time = 10 -- amount of time player has to do the hack
Config.Hack2Squares = 5 -- amount of squares player has to hack
Config.Hack2Repeat = 3 -- how many times player has to do the hack for success

-- loot 1
Config.Loot1Item = 'markedbills'-- item that can be received from loot 1 
Config.Loot1AmountMin = 15 -- Min amount that item can be received
Config.Loot1AmountMax = 35 -- Max amount that item can be received
Config.Loot1RareItem = 'weapon_machinepistol' -- rare item that can be received from loot 1 
...
Config.Loot2AmountMin = 2 -- Min amount that item can be received
Config.Loot2AmountMax = 4 -- Max amount that item can be received
Config.Loot2RareItem = 'weapon_m9' -- rare item that can be received from loot 1 
...
--NPC
Config.PedGun = 'weapon_smg' -- weapon NPC's use
