...
Config.useNewESX = false -- You can ignore this if you use QB Core
...
Config.Reward = { -- Get a Reward after complete the Mission.
    money = {enable = false, account = 'money' , amount = 100},
    item = {enable = false, itemname = 'bread', amount = 1}
}
...
Config.Enemies = {
    { -- This is only 1 Ped. It has other Spots to spawn so it dont always spawn at the same coords
        ...
        coords = {
            vector4(-1994.2575683594, 3182.8645019531, 32.810585021973, 63.040744781494),
            vector4(-1999.7181396484, 3171.1018066406, 32.810569763184, 124.59302520752),
            vector4(-2027.6116943359, 3199.3151855469, 32.810592651367, 247.54823303223),
            vector4(-2033.4426269531, 3195.595703125, 32.810642242432, 328.2741394043),
            vector4(-2029.7352294922, 3191.2641601562, 38.001419067383, 262.49835205078),
            vector4(-1997.5646972656, 3174.1713867188, 38.00142288208, 342.73004150391),
            vector4(-1998.609375, 3185.8400878906, 38.00142288208, 116.24118041992),
            vector4(-2009.8900146484, 3214.751953125, 38.054718017578, 328.22213745117),
            vector4(-1988.7864990234, 3197.0959472656, 38.001377105713, 247.28950500488),
            vector4(-1980.6848144531, 3194.0166015625, 32.810302734375, 80.707527160645),
